...
import com.casebeaumonde.activities.b_questionaries.b_colorPicker1.B_ColorPicker1
...
class B_ColorPicker : BaseClass(), B_SelectColor_IF {
    ...
    private lateinit var b_continue_bt: LinearLayout
    ...
    companion object {
        lateinit var selectcolorIf: B_ColorPicker
    }

    private fun listeners() {


        b_continue_bt.setOnClickListener {
