...
class Offers_Activity : BaseClass(), Controller.OfferListAPI, getOfferID_IF,
    ...
    private fun findIds() {
        offer_recieved = findViewById(R.id.offer_recieved)
        offer_sent = findViewById(R.id.offer_sent)
        offer_recycler = findViewById(R.id.offer_recycler)
        back = findViewById(R.id.back)
        offersentinvitations_recycler = findViewById(R.id.offersentinvitations_recycler)
        utility = Utility()
