...
class WorkInvitation_Activity : BaseClass(), Controller.WorkInvitationAPI, GetInviID_IF,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_work_invitation_)
    ...
    private fun findIds() {
        workinvitation_recieved = findViewById(R.id.workinvitation_recieved)
        workinvitation_sent = findViewById(R.id.workinvitation_sent)
        workinvitations_recycler = findViewById(R.id.workinvitations_recycler)
        worksentinvitations_recycler = findViewById(R.id.worksentinvitations_recycler)
