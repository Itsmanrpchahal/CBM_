...
class CustomerPlanFeaturesAdapter(
    var context: Context,
    val plansFeatures: List<PricingResponse.Data.CustomerPlan>?,
    val from:String,
    val token:String,
val pos : Int):RecyclerView.Adapter<CustomerPlanFeaturesAdapter.ViewHolder>() {
