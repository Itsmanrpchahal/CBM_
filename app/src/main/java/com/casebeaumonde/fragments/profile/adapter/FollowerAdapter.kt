...
class FollowerAdapter(
    val context: Context,
    val followers: MutableList<UserProfileResponse.Data.User.Follower>
) :
    ...
    override fun onBindViewHolder(holder: FollowerAdapter.ViewHolder, position: Int) {
        ...
        Glide.with(context).load(Constants.BASE_IMAGE_URL+list.avatar).placeholder(R.drawable.login_banner1).into(holder.itemView.userimage)
